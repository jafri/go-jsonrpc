...
[![go.dev reference](https://img.shields.io/badge/go.dev-reference-007d9c?logo=go&logoColor=white&style=flat-square)](https://pkg.go.dev/github.com/jafri/go-jsonrpc)
...
type _ interface {
    ...
    // * JSON-RPC error codes can be mapped to typed errors with jsonrpc.Errors - https://pkg.go.dev/github.com/jafri/go-jsonrpc#Errors
...
Dual-licensed under [MIT](https://github.com/jafri/go-jsonrpc/blob/master/LICENSE-MIT) + [Apache 2.0](https://github.com/jafri/go-jsonrpc/blob/master/LICENSE-APACHE)
